...
<body>
    <header>
        ...
        <nav>
            <ul>
                <li><a href="pages/inventario.html">CONTROL DE INVENTARIO</a></li>
                <li><a href="#">CONTROL DE SUMINISTROS</a></li>
            </ul>
        </nav>
    </header>
    <div class="indexContent">
        <img src="source/img/banner.jpg" alt="indexBanner">
        <div class="indexText">
            <p class="title">STARBUCKS STSS</p>
            <p>STARTRACK SUPPLY SYSTEM</p>
        </div>
        <a href="pages/iniciarSesion.html"><button type="button" class="indexButton"> Iniciar sesión</button></a>
    </div>
    <footer>
        ...
        <div class="footerContent">
            ...
            <div class="contact">
                ...
                <ul>
                    <li><a href="https://wa.me/51997701723">CONTACTO AL WHATSAPP</a></li>
